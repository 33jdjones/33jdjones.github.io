...
<head>
  <meta charset="UTF-8">
  <title>Jasmine Jones | Data Science Portfolio</title>
...
<body>
  ...
  <main>
    ...
    <section id="portfolio">
      ...
      <p class="project-placeholder">
        This section will showcase my projects as the semester progresses. Check back later for:
      </p>
      <ul>
        <li>Data cleaning and exploratory analysis projects</li>
        <li>Visualizations that highlight social and interdisciplinary questions</li>
        <li>Reflections on what I learned from each project</li>
      </ul>
    </section>
